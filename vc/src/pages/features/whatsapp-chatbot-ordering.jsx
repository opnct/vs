  ...
  useEffect(() => {
    const timer = setInterval(() => {
      const newLog = {
        ...
        message: `Processing Order Chatbot data shard...`,
      ...
      <section className="relative h-[70vh] flex items-center px-6 md:px-24 overflow-hidden border-b border-[#222]">
        ...
        <div className="relative z-20 max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-gray-400 max-w-2xl font-medium leading-relaxed border-l-2 border-[#005ea2] pl-6">
            Take orders automatically via AI Chatbot. Empowering Kirana owners with enterprise-grade logic.
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-8 bg-[#111] border border-[#222] rounded-sm overflow-hidden shadow-2xl">
            <div className="bg-[#1a1a1a] px-6 py-4 border-b border-[#222] flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-mono text-gray-500 ml-4 tracking-widest uppercase">System Terminal : FeatureWhatsappChatbotOrdering</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-[#005ea2] p-8 rounded-sm shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-blue-100 leading-relaxed mb-8 opacity-90">Deploying Order Chatbot impacts your bottom line by optimizing stock cycles.</p>
      ...
      <section className="py-32 px-6 md:px-24 bg-white text-black">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
          <div>
            ...
            <p className="text-xl leading-relaxed text-gray-700 mb-10 font-medium">VyaparSetu leverages a proprietary **Stateless Ledger Event Bus** (SLEB) to process Order Chatbot requests.</p>
          </div>
