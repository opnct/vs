...
export default function FeatureDirectToFarmerSourcing() {
  return (
    <div className='min-h-screen bg-black text-white p-24'>
      ...
      <h1 className='text-7xl font-black uppercase tracking-tighter mb-6 italic'>Direct Sourcing</h1>
      <p className='text-xl text-zinc-500 max-w-2xl'>Supply chain portal for direct farm buying</p>
    </div>
  );
}