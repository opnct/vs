...
export default function FeaturePackagingCostCalculator() {
  return (
    <div className='min-h-screen bg-black text-white p-24'>
      ...
      <h1 className='text-7xl font-black uppercase tracking-tighter mb-6 italic'>Packaging Calc</h1>
      <p className='text-xl text-zinc-500 max-w-2xl'>Precision margin after packaging costs</p>
    </div>
  );
}