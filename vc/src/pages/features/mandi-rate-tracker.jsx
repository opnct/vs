...
export default function FeatureMandiRateTracker() {
  return (
    <div className='min-h-screen bg-black text-white p-24'>
      ...
      <h1 className='text-7xl font-black uppercase tracking-tighter mb-6 italic'>Mandi Rate Tracker</h1>
      <p className='text-xl text-zinc-500 max-w-2xl'>Live price feeds from regional mandis</p>
    </div>
  );
}