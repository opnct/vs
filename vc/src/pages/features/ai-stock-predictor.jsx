...
export default function FeatureAiStockPredictor() {
  return (
    <div className='min-h-screen bg-black text-white p-24'>
      ...
      <h1 className='text-7xl font-black uppercase tracking-tighter mb-6 italic'>AI Stock Predictor</h1>
      <p className='text-xl text-zinc-500 max-w-2xl'>Predictive inventory based on local festivals and weather</p>
    </div>
  );
}