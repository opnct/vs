...
export default function LocKolkata() {
  return (
    <div className="animate-in fade-in duration-500 bg-white">
      <header className="bg-slate-900 text-white py-24 px-6 md:px-12 text-center border-b border-slate-800">
        <h1 className="text-4xl md:text-6xl font-black mb-6">Best POS Software in Kolkata</h1>
        <p className="text-xl text-slate-400 max-w-2xl mx-auto font-medium">Organize your supply chain perfectly.</p>
      </header>
      ...
      <section className="py-24 px-6 md:px-12 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-sm flex flex-col items-center justify-center min-h-[400px] relative overflow-hidden">
             ...
             <h3 className="text-2xl font-black text-gray-900 mb-2">Best POS Software in Kolkata</h3>
             <p className="text-slate-500 font-medium text-center max-w-xs">Organize your supply chain perfectly.</p>
          </div>
        </div>
      </section>
    </div>
