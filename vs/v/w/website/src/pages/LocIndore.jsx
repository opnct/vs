  ...
  return (
    <div className="animate-in fade-in duration-500">
      <header className="bg-blue-600 text-white py-24 px-6 md:px-12 text-center">
        <h1 className="text-4xl md:text-6xl font-black mb-4">Best POS Software in Indore</h1>
        <p className="text-xl text-blue-100 max-w-2xl mx-auto">Powering the cleanest city's retail network.</p>
      </header>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-slate-100 p-8 rounded-3xl border border-slate-200 shadow-inner flex items-center justify-center min-h-[300px]">
             <div className="text-center">
               ...
               <p className="text-slate-400 font-bold uppercase tracking-widest">LocIndore Visuals</p>
             </div>
          </div>
        </div>
      </section>
